    ...
    <>
      <div className=' flex absolute z-90  right-[1rem] top-[18rem] '>
        <div className='flex flex-col' role='group'>
          <button
            onClick={() => {
                console.log('yeah! search me!');   
            }}
            className=' bg-gray-800 p-1  rounded-md hover:bg-gray-600 text-maintext'
          >
          ...
          <button
            onClick={ROTATE_NORTH}
            className=' bg-gray-800 p-1 rounded-b-md hover:bg-gray-600 text-maintext'
          >
            <TiArrowUpThick
              style={{ transform: `rotate(${0}deg)`, transitionDuration: "100ms" }}
              size={22}
            />
          </button>
        </div>
